...
namespace Refactoring
{
    ...
    public class GameplayInputHandler : MonoBehaviour, IDomainInputHandler, IInputMoveProvider, IInputPressedProvider, ILockOnInputProvider
    {
        ...
        public void OnPressed(InputActionType action)
        {
            ...
            if (action == InputActionType.LockOn)
            {
