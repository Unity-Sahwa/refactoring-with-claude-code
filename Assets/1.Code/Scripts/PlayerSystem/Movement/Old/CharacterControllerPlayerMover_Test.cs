...
namespace Refactoring
{
    ...
    public class CharacterControllerPlayerMover_Test : MonoBehaviour
    {
        ...
        [Inject(true)] private ICharacterSwapNotifier _swapNotifier;          // 옵션: 스왑 시 재획득 통지에만 사용
        ...
        private void OnCharacterSwapped() => AcquireCurrentCharacter();
        ...
        private void AcquireCurrentCharacter()
        {
            ...
            _hitProvider = character.GetComponent<ControllerHitLogger_Test>();
            _verticalSpeed = 0f;
        }
